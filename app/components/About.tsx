...
const About = () => {
  return (
    <section className="relative py-32 h-auto flex items-center">
      <div className="relative max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center justify-center">
          {/* Left Section */}
          <div className="col-span-1 mt-4">
            <h2 className="text-3xl sm:text-xl md:text-4xl font-bold mb-4 text-gray-900 text-center md:text-left">
              About Our Cafe
            </h2>
